            ...
            call.enqueue(new Callback<AmazonCalculationResponse>() {
                ...
                public void onResponse(Call<AmazonCalculationResponse> call, Response<AmazonCalculationResponse> response) {
                    if(response.isSuccessful()) {
                        ...
                        Local.add(String.valueOf(CalculateResponse.getAmazonLocal().getRCF()));
                        Local.add(String.valueOf(CalculateResponse.getAmazonLocal().getGstOnRCF()));
                        ...
                        Regional.add(String.valueOf(CalculateResponse.getAmazonRegional().getRCF()));
                        Regional.add(String.valueOf(CalculateResponse.getAmazonRegional().getGstOnRCF()));
                        ...
                        National.add(String.valueOf(CalculateResponse.getAmazonNational().getRCF()));
                        National.add(String.valueOf(CalculateResponse.getAmazonNational().getGstOnRCF()));
